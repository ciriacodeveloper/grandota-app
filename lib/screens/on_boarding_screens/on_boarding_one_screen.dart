...
import 'package:grandota/screens/on_boarding_screens/on_boarding_dos_screen.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: CustomButton(
                ...
                onPressed: () => Navigator.pushAndRemoveUntil(context, PageTransition(type: PageTransitionType.fade, child: const OnBoardingDosScreen()), (route) => false),
              ),
            ),
            InkWell(
              child: Container(
