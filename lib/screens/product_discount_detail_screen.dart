...
class ProductDiscountDetailScreen extends StatefulWidget {
  const ProductDiscountDetailScreen({Key? key}) : super(key: key);

  @override
  _ProductDiscountDetailScreenState createState() => _ProductDiscountDetailScreenState();
}

class _ProductDiscountDetailScreenState extends State<ProductDiscountDetailScreen> {
                      ...
                      child: Container(
                        ...
                        decoration: const BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: AssetImage('assets/images/category_one.png'),
                              fit: BoxFit.cover),
                        ),
                        child: Align(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('-10%',style: GoogleFonts.poppins(fontSize: 18,color: const Color(0xff62b621)),)
                              ],
                            ),
                          ),
                        ),
