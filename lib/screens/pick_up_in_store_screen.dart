...
class PickUpInStoreScreen extends StatefulWidget {
  const PickUpInStoreScreen({Key? key}) : super(key: key);

  @override
  _PickUpInStoreScreenState createState() => _PickUpInStoreScreenState();
}

class _PickUpInStoreScreenState extends State<PickUpInStoreScreen> {
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Text('Datos de recojo',style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 16),overflow: TextOverflow.ellipsis,),
                                  InkWell(
                              ...
                              Text('Grandota',style: GoogleFonts.poppins(),maxLines: 1,overflow: TextOverflow.ellipsis,),
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text('Tienda',style: GoogleFonts.poppins(fontWeight: FontWeight.w600),maxLines: 1,overflow: TextOverflow.ellipsis,),
                                        Text('Av. Chimpu Ocllo 513 Urb. Santa Isabel, Carabayllo 15121 Lima, Perú',style: GoogleFonts.poppins(),maxLines: 2,overflow: TextOverflow.ellipsis,),
                                      ],
                                    ),
                                  )
                                ],
        ...
        return SliverChildListDelegate(
            [
              ...
              Padding(
                ...
                child: CustomButton(text: 'Recojo en Tienda', width: double.infinity, height: 50, onPressed: (){}, sizeText: 18),
              )
            ]
        );
      },
